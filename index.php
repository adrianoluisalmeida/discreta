...
<header class="header">
    <div class="container container-palette top-bar affix-menu">
        <div class="container-top">
            <div class="clearfix">
                <div class="pull-right navigation-wrapper navigation-middle"><a href="" class="button-close"></a>
                    <ul class="nav navbar-nav nav-items default-menu" id="main-menu">
                        <li class="dropdown active">
                            <a class="dropdown-toggle" data-toggle="dropdown" href="https://github.com/adrianoluisalmeida/discreta" target="_blank">
                                GitHub do projeto <span class="caret"></span>
                            </a>
                        </li>
                    </ul>
                </div>
...
<div class="section widget-geomap container container-palette">
    <div class="container">
        <div class="geomap-title"><span class="mark-c">Seletor de rotas</span><br/>
            O caminho mais rápido a seu destino
        </div>
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <!--                <div class="geo-map" id='geo-map'><img src="assets/usa.svg" alt=""/></div>-->
                <style>
                    #svg-map path {
                        fill: #DA3743
                    }
                ...
                <svg version="1.1" id="svg-map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 450 460" enable-background="new 0 0 450 460" xml:space="preserve">
                    <g>
                        ...
                        <a xlink:href="#riograndedonorte" class="estado" name="Rio Grande do Norte" code="24">
                        ...
                        <a xlink:href="#santacatarina" class="estado" name="Santa Catarina" code="42">
                        ...
                        <a xlink:href="#riograndedosul" class="estado" name="Rio Grande do Sul" code="43">
                        ...
                        <a xlink:href="#minasgerais" class="estado" name="Minas Gerais" code="31">
                        ...
                        <a xlink:href="#riodejaneiro" class="estado" name="Rio de Janeiro" code="33">
                        ...
                        <a xlink:href="#espiritosanto" class="estado" name="Espírito Santo" code="32">
                        ...
                        <a xlink:href="#distritofederal" class="estado" name="Distrito Federal" code="53">
...
<footer class="footer container container-palette">
    <div class="footer-bottom">
        <div class="container"><span>Adriano, Everson e Joel. Matemática Discreta 2018</span></div>
    </div>
</footer>
